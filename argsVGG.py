...
def parse_argsRLST():
    ...
    # primary
    parser.add_argument(
        "--configs", type=str, default="configs/configsVGG.yml", help="configs file",
    )
    parser.add_argument(
        "--result-dir",
    ...
    parser.add_argument(
        "--layer-type", type=str, choices=("dense", "arlst"), help="dense | arlst"
    )
    parser.add_argument(
        "--init_type",
    ...
    # Additional
    parser.add_argument(
        "--gpu", type=str, default="7", help="Comma separated list of GPU ids"
    )
    parser.add_argument(
