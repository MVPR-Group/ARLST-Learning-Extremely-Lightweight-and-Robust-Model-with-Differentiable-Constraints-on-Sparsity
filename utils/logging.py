...
# from utils.model import subnet_to_dense_200, subnet_to_dense, subnet_to_dense_AsyConv
...
# def save_checkpoint_200(state, is_best, args, result_dir, filename="checkpoint.pth.tar", save_dense=False):
#     torch.save(state, os.path.join(result_dir, filename))
#     if is_best:
#         shutil.copyfile(
#             os.path.join(result_dir, filename),
...
#
#     if save_dense:
#         state["state_dict"] = subnet_to_dense_200(state["state_dict"], args.k)
#         torch.save(
#             subnet_to_dense_200(state, args.k),
#             os.path.join(result_dir, "checkpoint_dense.pth.tar"),
#         )
#         if is_best:
#             shutil.copyfile(
