...
from utils.eval import accuracy,accuracy_1
...
def train(
    ...
    for i, data in enumerate(dataloader):
        ...
        #单类准确度
        # a_11,a_22,a_33,a_44,a_55,a_66,a_77,a_88,a_99 = accuracy_1(output, target, topk=(1, 5))
        # a_1.append(a_11)
        # a_2.append(a_22)
        # a_3.append(a_33)
        # a_4.append(a_44)
        ...
        #     writer.add_image(
        #         "training-images",
        #         torchvision.mutils.make_grid(images[0 : len(images) // 4]),
        #     )
        # writer.add_scalar("Loss",loss,global_step=epoch,walltime=None)
        # writer.add_scalar("Accuracy", acc1, global_step=epoch, walltime=None)
