...
class imagenet:
    ...
    def data_loaders(self, **kwargs):
        trainset = datasets.ImageFolder(
            root = "/home/huangyanhui/hydra-master/datasets/imagenet/train", transform=self.tr_train
        )
        testset = datasets.ImageFolder(
            root = "/home/huangyanhui/hydra-master/datasets/imagenet/val",transform=self.tr_test
        )
